...
class RNAFolding(flsd.Landscape):
...
class RNABinding(flsd.Landscape):
    ...
    def get_fitness(self, sequences):
        ...
        for sequence in sequences:
            ...
            if self.threshold:
                ...
                fitness = -duplex.energy / (self.norm_value * len(sequence) / len(self.target))
...
class Conserved_RNA_landscape_random(flsd.Landscape):
    """
