...
evaluator_ppo = Evaluator(
    ppo_explorer, landscape_types=LANDSCAPE_TYPES_TF, path="../simulations/eval/TF/PPO/"
)
evaluator_ppo.evaluate_for_landscapes(evaluator_ppo.adaptivity, num_starts=5)
