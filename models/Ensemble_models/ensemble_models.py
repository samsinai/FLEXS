...
class EnsembleModel(Model):
    def __init__(self, ground_truth_oracle, architectures, model_score_threshold=0.5, cache=True):
        """
    ...
    def reset(self):
        ...
        for i, model in enumerate(self.models):
            ...
            self.models[i].compile(loss='mean_squared_error', optimizer='adam', metrics=['mse'])
